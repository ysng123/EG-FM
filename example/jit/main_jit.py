...
def get_args_parser():
    ...
    # EG-FM path
    parser.add_argument('--egfm_sigma0', default=3.5, type=float)
    parser.add_argument('--egfm_curve', default='smootherstep', type=str)
    parser.add_argument('--egfm_release_start', default=0.0, type=float)
    parser.add_argument('--egfm_release_end', default=1.0, type=float)
